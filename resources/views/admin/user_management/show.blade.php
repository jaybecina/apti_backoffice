                    ...
                    <div class="page-title-box d-sm-flex flex-column align-items-start">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item fw-bold">Update User Account</li>
                            </ol>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            value="PASSWORDPASSWORDPASSWORDPASSWORDPASSWORDPASSWORD"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <button class="btn btn-warning">Send Password Reset Link</button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="first_name" id="first_name" value="{{ $user->userDetails->first_name }}" class="form-control">
                                            @error('first_name')
                                                <span class="invalid-feedback" role="alert" style="display: block">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="middle_name" id="middle_name" value="{{ $user->userDetails->middle_name }}" class="form-control">
                                            @error('middle_name')
                                                <span class="invalid-feedback" role="alert" style="display: block">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="last_name" id="last_name" value="{{ $user->userDetails->last_name }}" class="form-control">
                                            @error('last_name')
                                                <span class="invalid-feedback" role="alert" style="display: block">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="contact_number" value="{{ $user->userDetails->contact_number }}" id="contact_number" class="form-control">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="file" id="profile_picture" name="profile_picture" class="dropify"
                                                ...
                                                data-default-file="{{ asset($user->userDetails->profile_picture) }}"
                                                />
                                        </div>
